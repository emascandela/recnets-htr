...
# from torchvision._api import register_model, Weights, WeightsEnum
# from torchvision._meta import _IMAGENET_CATEGORIES
...
class _ResNet(BaseModel):
    ...
    def __init__(
        ...
        if self.base_params.variant == "r34":
            model_fn = resnet34
        elif self.base_params.variant == "r50":
            model_fn = resnet50

        self.model = model_fn(share_layers=self.share_params.share_layers, num_classes=self.base_params.num_outputs)
